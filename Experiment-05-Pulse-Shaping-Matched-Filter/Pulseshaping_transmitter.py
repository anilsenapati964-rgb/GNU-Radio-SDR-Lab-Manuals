...
class Pulseshaping_transmitter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pulseShaping_transmit", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pulseShaping_transmit")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Pulseshaping_transmitter")
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            log=False,
            truncate=False)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 3, 100000))), True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/4), 0.35, 352))




def main(top_block_cls=Pulseshaping_transmitter, options=None):
